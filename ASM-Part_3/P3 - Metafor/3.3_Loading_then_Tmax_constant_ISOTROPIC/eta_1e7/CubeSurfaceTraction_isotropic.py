...
Tcycle = 10.                        #Duration of one cycle
...
# Keep t_max, 0 and -tmax during infinite cycle
fct2 = PieceWiseLinearFunction()
for i in range (1,10):
    fct2.setData(0.,0.) #POINT n°1
    fct2.setData(Tcycle/4.0,1.0)#POINT n°2
    fct2.setData(+Tcycle/4.0,1.0)#POINT n°4
    fct2.setData(Tcycle*2.0/4.0,0.0)#POINT n°4
    fct2.setData(Tcycle*3.0/4.0,-1.0)#POINT n°5   
    fct2.setData(Tcycle*4.0/4.0,0.0)#POINT n°5 
    fct2.setData(i*Tcycle+Tcycle/4.0,1.0)#POINT n°2
    fct2.setData(i*Tcycle+Tcycle*2.0/4.0,1.0)#POINT n°3
    fct2.setData(i*Tcycle+Tcycle*3.0/4.0,1.0)#POINT n°4
    fct2.setData(i*Tcycle+Tcycle*4.0/4.0,1.0)#POINT n°5 
#########################################
...
prp2.put(PRESSURE,  Trac)                             
prp2.depend (PRESSURE, fct2, Field1D(TM,RE)) # To apply your new function, you can put it instead of "fct" here
