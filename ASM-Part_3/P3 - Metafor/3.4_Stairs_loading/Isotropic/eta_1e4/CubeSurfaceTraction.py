...
for i in range (1,2):
    ...
    fct2.setData(i*(Tcycle/4.0),1.0)#POINT n°2
    fct2.setData(i*(Tcycle+Tcycle/4.0),1)#POINT n°3
    fct2.setData(i*(Tcycle+Tcycle/2),0.0)#POINT n°4
    fct2.setData(i*(2*Tcycle+Tcycle/2),0)#POINT n°4
    fct2.setData(i*(2*Tcycle+3*Tcycle/4),-1.0)#POINT n°5   
    fct2.setData(i*(3*Tcycle+3*Tcycle/4),-1.0)#POINT n°5  
    fct2.setData(i*(4*Tcycle),0.0)#POINT n°5  
    fct2.setData(i*(5*Tcycle),0.0)#POINT n°5  
