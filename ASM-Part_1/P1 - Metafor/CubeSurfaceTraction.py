...
#GEOMETRY:
p= {} 
p['GeometryHypothesis'] = "PLANESTRESS"
...
lawset = domain.getMaterialLawSet()
lawset1 = lawset.define(2, LinearIsotropicHardening)  #Create law number 1 as Linear Isotropic hardening law
lawset1.put(IH_SIGEL,   SigmaY_0) #Set law parameters (see required parameters in the documentation)
lawset1.put(IH_H, h)

#Linear kinematic hardening
lawset = domain.getMaterialLawSet()
lawset1 = lawset.define(3, KinematicHardening)
lawset1.put(IH_SIGEL,   SigmaY_0)
lawset1.put(KH_H,  h)
...
if p['GeometryHypothesis']=="PLANESTRESS":
    ...
    loadingset.define(sideset(6),Field1D(TX,RE),0.)
    #loadingset.define(sideset(4),Field1D(TX,RE),0.) X??????,
