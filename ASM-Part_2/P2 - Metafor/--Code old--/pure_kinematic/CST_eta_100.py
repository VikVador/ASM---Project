...
hi = theta_m * h                        # Isotropic hardening coefficient

hk = (1 - theta_m) * h                  # Kinematic hardening coefficient

etak = 200                               # Dynamic recovery parameter
...
lawset1 = lawset.define(1, LinearIsotropicHardening)  #C reate law number 1 as Linear Isotropic hardening law 
...
# Energy 1 - Internal, kinetic and disspated
valuesmanager.add(14, TdFieldValueExtractor(pointset(node_id), THERMODYN_POT_INT), "U")
valuesmanager.add(15, TdFieldValueExtractor(pointset(node_id), THERMODYN_EN_CIN), "K")
valuesmanager.add(16, TdFieldValueExtractor(pointset(node_id), THERMODYN_EN_DIS), "E_diss")
...
# Energies 1
dataCurve_U = VectorDataCurve(13, valuesmanager.getDataVector(1), valuesmanager.getDataVector(14), "U")
dataCurve_K = VectorDataCurve(14, valuesmanager.getDataVector(1), valuesmanager.getDataVector(15), "K")
dataCurve_Diss = VectorDataCurve(15, valuesmanager.getDataVector(1), valuesmanager.getDataVector(16), "E_diss")

dataCurveSet5 = DataCurveSet()
dataCurveSet5.add(dataCurve_U)
dataCurveSet5.add(dataCurve_K)
dataCurveSet5.add(dataCurve_Diss)
winc5 = VizWin()
