...
%% Strain
figure
plot(results(:,1),results(:,8)*100,'LineWidth',2.0)
hold on 
plot(results(:,1),results(:,9)*100,'LineWidth',2.0)
plot(results(:,1),results(:,10)*100,'LineWidth',2.0)
plot(results(:,1),results(:,7)*100,'LineWidth',2.0)
grid on
